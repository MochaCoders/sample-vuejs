<template>
  <div>
    <div class="grid grid-cols-1 m-auto sm:grid-cols-2">
      <div class="bg-cover sm:w-full sm:h-screen image lg:w-full">
      </div>
      <div class="w-11/12 m-auto mt-10 sm:m-auto sm:w-3/4 lg:w-1/2">
        ...
        <h2 class="mt-10 text-xl font-bold minerva-color lg:mb-4">Sign Up</h2>
        <RegisterForm />
        <h3 class="mt-5 text-center">OR</h3>
